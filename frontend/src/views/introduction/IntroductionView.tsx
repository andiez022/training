  ...
  return (
    <div>
      ...
      <div className="intro-content">
        ...
        <svg className="logo" data-aos="fade-up" data-aos-once="true">
          <image xlinkHref={logo} />
        </svg>
        <p className="intro-content__title" data-aos="fade-up" data-aos-once="true">
          안녕하십니까. 깨끗한 바다 부산 홈페이지 방문을 환영합니다.
        </p>

        <p className="intro-content__paragraph-1" data-aos="fade-up" data-aos-once="true">
        ...
        <p className="intro-content__paragraph-2" data-aos="fade-up" data-aos-once="true">
        ...
        <p className="intro-content__paragraph-3" data-aos="fade-up" data-aos-once="true">
        ...
        <p className="intro-content__paragraph-4" data-aos="fade-up" data-aos-once="true">
          아름다운 미래 해양도시 부산을 위하여 시민 여러분들의 많은 관심과 참여를 부탁드립니다. 감사합니다.
        </p>
        <p className="intro-content__paragraph-5" data-aos="fade-up" data-aos-once="true">
